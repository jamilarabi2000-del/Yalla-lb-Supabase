...
// Sellers Management State & Sync
  ...
  // Yalla storefront is USD-only. Keep the legacy conversion API for
  // backwards compatibility with order/storage code, but never expose LBP
  // through customer-facing price formatting.
