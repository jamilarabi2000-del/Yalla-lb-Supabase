...
export const CategoryProductsOrderModal: React.FC<CategoryProductsOrderModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-slate-50 backdrop-blur-xs animate-in fade-in duration-200">
      <div 
        ref={modalRef}
        role="dialog"
        aria-modal="true"
        ...
        <div className="flex-1 overflow-y-auto p-3 sm:p-5 space-y-2.5 bg-slate-100/50">
          {displayedItems.length === 0 ? (
            <div className="bg-white p-12 rounded-2xl border border-slate-200/80 text-center space-y-3">
              <div className="w-14 h-14 rounded-full bg-slate-100 text-slate-500 flex items-center justify-center mx-auto text-xl">
                📦
              </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-3.5 min-w-0 flex-1">
                    <div className="w-14 h-14 rounded-xl overflow-hidden bg-slate-50 border border-slate-200 shrink-0 relative flex items-center justify-center p-0.5">
                      ...
                      />
                      {prod.isFeatured && (
                        <div className="absolute top-1 left-1 w-4 h-4 rounded-full bg-amber-500 text-slate-900 flex items-center justify-center shadow-xs">
                  ...
                  <div className="flex items-center gap-2 shrink-0 self-end sm:self-center flex-wrap">
                    ...
                    <div className="flex items-center gap-1 bg-slate-50 p-1 rounded-xl border border-slate-200 text-xs">
                      <span className="text-[10px] text-slate-500 font-bold pl-1 flex items-center gap-0.5">
