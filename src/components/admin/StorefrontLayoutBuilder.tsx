  ...
  return <section className="space-y-5">
    ...
    <div className="grid grid-cols-1 2xl:grid-cols-[minmax(0,1fr)_minmax(360px,0.85fr)] gap-5 items-start">
      <div className="space-y-5">
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-5">
          <div className="flex items-center justify-between mb-4"><div><div className="text-[10px] uppercase tracking-widest font-bold text-slate-500">Home</div><h3 className="text-lg font-black">Live section hierarchy</h3></div><span className="text-[10px] font-bold text-emerald-700">DRAG TO REORDER</span></div>
