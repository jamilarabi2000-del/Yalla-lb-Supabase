 ...
 *
 * Each path is the brand's own glyph as published by Simple Icons
 * (https://simpleicons.org, v16.32.0, CC0 1.0), unmodified, and each colour is
 * the brand's own. Keep them exact: a look-alike drawn by hand is what this
 * file replaced.
 */
